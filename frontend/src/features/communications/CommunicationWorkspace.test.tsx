...
describe("CommunicationWorkspace",()=>{
  it("creates and replies to patient-bound secure threads",async()=>{
    ...
    const api=vi.fn().mockResolvedValueOnce([]).mockResolvedValueOnce(summary).mockResolvedValueOnce([summary]).mockResolvedValueOnce({...summary,messages:[{uuid:"message-1",sender_kind:"staff",body:"Follow up",created_at:"2026-01-01T00:00:00Z"}]}).mockResolvedValueOnce([summary]);
