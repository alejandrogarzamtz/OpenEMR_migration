...
| Standard OpenEMR API | Partial | all 5 legacy portal routes and 61 of 97 Standard API routes have authenticated, audited compatibility contracts and the legacy response envelope, including the core chart lists, SOAP notes and vital signs; remaining route state is explicit in `LEGACY_API_INVENTORY.md` |
