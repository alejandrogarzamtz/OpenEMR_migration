...
| Reports | Partial | all 48 legacy PHP surfaces are cataloged and 28 have migrated workflows, now including the multidimensional clinical cohort report; 20 remain pending/embedded, including two billing-builder assets that cannot be verified before their parent workflow |
