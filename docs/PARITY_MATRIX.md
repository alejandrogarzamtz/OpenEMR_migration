...
| Patient demographics | Partial | normalized multiple addresses, telecoms, related people and employment history preserve priority, validity, primary/emergency status, medical-information/decision flags and historical periods with audited React workflows; structured previous names are searchable, audited and manageable from the patient chart; advanced editing, consent/custom fields and complete legacy reconciliation remain |
