...
| Reports | Partial | all 48 legacy PHP surfaces are cataloged and 36 have migrated workflows, now including the six-metric 2026 ONC real-world-testing evidence report; 12 remain pending/embedded, including two billing-builder assets that cannot be verified before their parent workflow |
