...
| Reports | Partial | all 48 legacy PHP surfaces are cataloged and 30 have migrated workflows, now including integrated A/R collections and aging; 18 remain pending/embedded, including two billing-builder assets that cannot be verified before their parent workflow |
