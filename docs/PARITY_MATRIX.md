...
| Reports | Partial | all 48 legacy PHP surfaces are cataloged and 27 have migrated workflows, now including date/facility-scoped primary-insurance distribution; 21 remain pending/embedded, including two billing-builder assets that cannot be verified before their parent workflow |
