...
| Reports | Partial | all 48 legacy PHP surfaces are cataloged and 32 have migrated workflows, now including front-office and integrated-A/R receipt summaries; 16 remain pending/embedded, including two billing-builder assets that cannot be verified before their parent workflow |
