...
| Reports | Partial | all 48 legacy surfaces are cataloged and 24 report families have reproducible runs, now including configurable patient-education search resources; 24 report implementations remain |
