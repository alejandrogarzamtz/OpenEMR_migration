...
| Reports | Partial | all 48 legacy PHP surfaces are cataloged and 33 have migrated workflows, now including lossless payment-gateway audit and reversal reporting; 15 remain pending/embedded, including two billing-builder assets that cannot be verified before their parent workflow |
