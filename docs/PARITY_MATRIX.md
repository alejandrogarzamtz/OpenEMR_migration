...
| Reports | Partial | all 48 legacy surfaces are cataloged and 22 report families have reproducible runs, now including referral-loop tracking and reporting; 26 report implementations remain |
