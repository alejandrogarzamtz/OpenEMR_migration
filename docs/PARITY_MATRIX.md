...
| Reports | Partial | all 48 legacy surfaces are cataloged and 16 report families have reproducible runs; messaging/delivery, CVX immunization, inventory reconciliation and audit-tamper detection include ACL, filters, immutable snapshots, totals and CSV; 32 report implementations remain |
