...
| Care plans, teams and preferences | Partial | relational coded plans, named polymorphic care teams, and both clinical-preference categories now have typed lifecycle, auditing, React workflows and deterministic lossless import; goal/intervention outcome history, FHIR resources and production reconciliation remain |
