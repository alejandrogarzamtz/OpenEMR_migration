...
| Reports | Partial | all 48 legacy surfaces are cataloged and 13 report families have reproducible runs; secure-message history and outbound delivery operations now include ACL, filters, immutable snapshots, totals and CSV without exporting message bodies; 35 implementations remain |
