...
| Reports | Partial | all 48 legacy PHP surfaces are cataloged and 35 have migrated workflows, now including fee-code financial summaries and important-code filtering; 13 remain pending/embedded, including two billing-builder assets that cannot be verified before their parent workflow |
