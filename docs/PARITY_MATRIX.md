...
| Reports | Partial | all 48 legacy PHP surfaces are cataloged and 31 have migrated workflows, now including integrated A/R collections and front-office receipts; 17 remain pending/embedded, including two billing-builder assets that cannot be verified before their parent workflow |
