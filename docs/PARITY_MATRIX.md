...
| Reports | Partial | all 48 legacy surfaces are cataloged and 19 report families have reproducible runs; messaging/delivery, CVX immunization, inventory reconciliation, audit-tamper detection, physical-chart custody and background-service lease monitoring include ACL, immutable snapshots, totals and CSV; 29 report implementations remain |
