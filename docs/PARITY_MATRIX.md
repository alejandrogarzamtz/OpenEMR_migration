...
| Patient demographics | Partial | normalized multiple addresses, telecoms and related people preserve priority, validity, primary/emergency status and medical-information/decision flags with audited inactivation and React workflows; structured previous names are searchable, audited and manageable from the patient chart; employers, advanced editing, consent/custom fields and complete legacy reconciliation remain |
