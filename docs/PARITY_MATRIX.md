...
| Reports | Partial | all 48 legacy surfaces are cataloged and 21 report families have reproducible runs, now including categorized service codes and multi-level pricing; 27 report implementations remain |
