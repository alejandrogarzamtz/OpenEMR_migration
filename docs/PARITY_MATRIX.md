...
| Reports | Partial | all 48 legacy surfaces are cataloged and 14 report families have reproducible runs; messaging/delivery operations and CVX-based immunization reporting include ACL, filters, immutable snapshots, totals and CSV; HL7 VXU remains integration work and 34 report implementations remain |
