...
| Reports | Partial | all 48 legacy surfaces are cataloged and 20 report families have reproducible runs, now including enforced IP login blocking and administrative tracking; 28 report implementations remain |
