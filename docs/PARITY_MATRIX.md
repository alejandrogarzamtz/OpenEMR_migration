...
| SMART on FHIR/OAuth | Partial | SMART 2.2 Backend Services discovery, audited asymmetric client registration, RS384/ES384 private-key JWT authentication, system read/search scopes, five-minute access tokens, replay protection, introspection, client/token revocation and React administration exist; interactive EHR/patient launch, authorization code + PKCE, OpenID Connect and launch context remain |
