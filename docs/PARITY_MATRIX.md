...
| Reports | Partial | all 48 legacy surfaces are cataloged and 18 report families have reproducible runs; messaging/delivery, CVX immunization, inventory reconciliation, audit-tamper detection and physical-chart custody include ACL, filters, immutable snapshots, totals and CSV; 30 report implementations remain |
