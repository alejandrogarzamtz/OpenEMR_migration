...
| Reports | Partial | all 48 legacy PHP surfaces are cataloged and 29 have migrated workflows, now including appointment/encounter reconciliation and billing diagnostics; 19 remain pending/embedded, including two billing-builder assets that cannot be verified before their parent workflow |
