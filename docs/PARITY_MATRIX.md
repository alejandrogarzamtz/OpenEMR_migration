...
| Reports | Partial | all 48 legacy PHP surfaces are cataloged and 34 have migrated workflows, now including standalone open-prepayment balance reconciliation; 14 remain pending/embedded, including two billing-builder assets that cannot be verified before their parent workflow |
