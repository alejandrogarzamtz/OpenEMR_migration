...
| Reports | Partial | all 48 legacy surfaces are cataloged and 15 report families have reproducible runs; messaging/delivery, CVX immunization and ledger-reconciled inventory activity include ACL, filters, immutable snapshots, totals and CSV; 33 report implementations remain |
