...
| Standard OpenEMR API | Partial | all 5 legacy portal routes and 69 of 98 Standard API routes have authenticated, audited compatibility contracts and the legacy response envelope, including the core chart lists, SOAP notes, vital signs, users and reference/insurance catalogs; remaining route state is explicit in `LEGACY_API_INVENTORY.md` |
