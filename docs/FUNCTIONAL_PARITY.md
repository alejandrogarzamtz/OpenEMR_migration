...
| SCH-001 | Calendar, appointments, holidays, reminders and flow board | `interface/main/calendar`, tracker and appointment services | `openemr_postcalendar_*`, `patient_tracker*`; recurrence/status/resource rules | scheduling router with filters, resource conflicts, lifecycle, immutable flow events and lossless import | Agenda list/create/actions and live patient-flow board | API, conflict, transition, ACL, import helper and component tests | IN PROGRESS — appointments and patient flow are migrated; recurrence expansion, multi-provider events, categories, holidays, wait list and reminder delivery remain |
