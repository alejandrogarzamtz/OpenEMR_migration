...
| SCH-001 | Calendar, appointments, holidays, reminders and flow board | `interface/main/calendar`, tracker and appointment services | `openemr_postcalendar_*`, `patient_tracker*`; recurrence/status/resource rules | scheduling router with filters, resource conflicts, lifecycle and lossless import | Agenda list/create/actions | API, conflict, ACL, import helper and component tests | IN PROGRESS — standard appointment routes migrated; recurrence expansion, multi-provider events, categories, holidays, wait list, reminders delivery and flow board remain |
